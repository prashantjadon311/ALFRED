...
export interface MessageDoc extends OwnedDoc {
  userId: ObjectId; workspaceId: ObjectId; chatId: ObjectId; projectId?: ObjectId; role: "user" | "assistant" | "system" | "tool"; content: string; modelId?: ObjectId; providerType?: string; modelName?: string; inputTokens?: number; outputTokens?: number; cachedInputTokens?: number; cacheWriteInputTokens?: number; reasoningTokens?: number; costUsd?: number; pricingSnapshotId?: string; usageSource?: "exact" | "estimated"; costSource?: "exact" | "estimated" | "unavailable"; calculatedAt?: Date; latencyMs?: number; parentMessageId?: ObjectId; metadata?: Record<string, unknown>; createdAt: Date;
}
@Injectable()
